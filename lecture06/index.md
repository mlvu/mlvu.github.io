...
<nav class="menu">
    <ul>
        ...
        <li class="name">Lecture 6: Beyond linear models</li>
            ...
            <li><a href="#video-070">Lagrange multipliers</a></li>
            <li><a href="#video-088">The kernel trick</a></li>
...
<article class="slides">
       ...
       <section id="slide-015">
            ...
            <figcaption>
            <p    >Before we dig into the details, we can get a sense of what neural network training looks like in the <a href="http://playground.tensorflow.org/#activation=sigmoid&amp;batchSize=10&amp;dataset=circle&amp;regDataset=reg-plane&amp;learningRate=0.03&amp;regularizationRate=0&amp;noise=0&amp;networkShape=7&amp;seed=0.76686&amp;showTestData=false&amp;discretize=true&amp;percTrainData=50&amp;x=true&amp;y=true&amp;xTimesY=false&amp;xSquared=false&amp;ySquared=false&amp;cosX=false&amp;sinX=false&amp;cosY=false&amp;sinY=false&amp;collectStats=false&amp;problem=classification&amp;initZero=false&amp;hideText=false&amp;noise_hide=false&amp;activation_hide=false&amp;regularization_hide=true"><strong class="blue">tensorflow playground</strong></a>. Play around with the different datasets and different activations.<br></p><p     class="list-item">Note how the shape of the decision boundary changes based on the activation functions we choose (curvy for sigmoid, piecewise linear for ReLU)<br></p><p     class="list-item">Note that adding another layer makes the network much more difficult to train (especially with sigmoid activations).<br></p><p     class="list-item">Try the linear activation (i.e. no activations on the hidden nodes). Note that all you get is a linear decision boundary, not matter how many layers you try.</p><p     class="list-item"></p>
            </figcaption>
       </section>
       ...
       <section id="slide-016">
            ...
            <figcaption>
            <p    >That’s the basic idea of neural networks. So far, it’s hopefully a pretty simple idea. The complexity of neural networks lies in computing the gradients. For such complex models, sitting down at the kitchen table with a stack of papers and a pencil, and working out a symbolic expression for the gradient is no longer feasible. If we manage it at all, we get horrible convoluted expressions that no longer reduce to nice, simple functions, as they did in the case of linear regression and logistic regression.<br></p><p    >To help us out, we need the <strong>backpropagation</strong> algorithm, which we’ll discuss in the next video.</p><p    ></p>
            </figcaption>
       </section>
       ...
       <section id="slide-021">
            ...
            <figcaption>
            <p    >Here’s the three steps required to implement backpropagation for a given function.<br></p><p    >Don't worry if this seems abstract, it should become clearer when we look at an example.</p><p    ></p>
            </figcaption>
       </section>
       ...
       <section id="slide-021" class="anim">
            ...
            <figcaption>
            <p    >To show that backpropagation is a<em> generic </em>algorithm for working out gradients, not just a method for neural networks, we’ll first show how it works for some arbitrary scalar function: f(x) = 2/sin(e<sup>-x</sup>).<br></p><p    >First we take our function f, and we break it up into a chain of smaller functions, the output of each feeding into the next. Defining the functions <span>a</span>, <span>b</span>, <span>c</span>, and <span>d</span> as shown, we can write f(<span class="blue">x</span>) = <span class="orange">d</span>(<span class="orange">c</span>(<span>b</span>(<span class="green">a</span>(<span class="blue">x</span>)))). <br></p><p    >The graph on the right is a called a <strong>computation graph</strong>: each node represents a small computer program that receives an input, computes an output and passes it on to another module.<br></p><aside    >Normally, we wouldn’t break a function up in such small modules: this is just a simple example to illustrate the principle.</aside><aside    ></aside>
            </figcaption>
            <span class="hint">click image for animation</span>
       </section>
       ...
       <section id="slide-022" class="anim">
            ...
            <figcaption>
            <p    >Because we’ve described our function as a composition of modules, we can work out the derivative purely by repeatedly applying the chain rule.<br></p><p    >Since we know for each function what the argument is, we’ll leave the arguments out to keep the notation clean.<br></p><p    ></p>
            </figcaption>
            <span class="hint">click image for animation</span>
       </section>
       ...
       <section id="slide-029" class="anim">
            ...
            <img src="32.Linear.key-stage-0030anim0.svg" data-images="32.Linear.key-stage-0030anim0.svg,32.Linear.key-stage-0030anim1.svg,32.Linear.key-stage-0030anim2.svg,32.Linear.key-stage-0030anim3.svg,32.Linear.key-stage-0030anim4.svg" class="slide-image" />
       ...
       <section id="slide-030" class="anim">
            ...
            <img src="32.Linear.key-stage-0031anim0.svg" data-images="32.Linear.key-stage-0031anim0.svg,32.Linear.key-stage-0031anim1.svg,32.Linear.key-stage-0031anim2.svg,32.Linear.key-stage-0031anim3.svg" class="slide-image" />
       ...
       <section id="slide-034">
            ...
            <img src="32.Linear.key-stage-0034.svg" class="slide-image" />
       ...
       <section id="slide-034" class="anim">
            ...
            <img src="32.Linear.key-stage-0035anim0.svg" data-images="32.Linear.key-stage-0035anim0.svg,32.Linear.key-stage-0035anim1.svg,32.Linear.key-stage-0035anim2.svg,32.Linear.key-stage-0035anim3.svg,32.Linear.key-stage-0035anim4.svg,32.Linear.key-stage-0035anim5.svg,32.Linear.key-stage-0035anim6.svg" class="slide-image" />
       ...
       <section id="slide-035" class="anim">
            ...
            <img src="32.Linear.key-stage-0036anim0.png" data-images="32.Linear.key-stage-0036anim0.png,32.Linear.key-stage-0036anim1.png,32.Linear.key-stage-0036anim2.png,32.Linear.key-stage-0036anim3.png" class="slide-image" />
       ...
       <section id="slide-038" class="anim">
            ...
            <img src="32.Linear.key-stage-0039anim0.svg" data-images="32.Linear.key-stage-0039anim0.svg,32.Linear.key-stage-0039anim1.svg,32.Linear.key-stage-0039anim2.svg,32.Linear.key-stage-0039anim3.svg,32.Linear.key-stage-0039anim4.svg,32.Linear.key-stage-0039anim5.svg" class="slide-image" />
       ...
       <section id="slide-041" class="anim">
            ...
            <img src="32.Linear.key-stage-0042anim0.svg" data-images="32.Linear.key-stage-0042anim0.svg,32.Linear.key-stage-0042anim1.svg" class="slide-image" />
       ...
       <section id="slide-046" class="anim">
            ...
            <img src="32.Linear.key-stage-0047anim0.svg" data-images="32.Linear.key-stage-0047anim0.svg,32.Linear.key-stage-0047anim1.svg,32.Linear.key-stage-0047anim2.svg,32.Linear.key-stage-0047anim3.svg" class="slide-image" />
       ...
       <section id="slide-052" class="anim">
            ...
            <img src="32.Linear.key-stage-0053anim0.svg" data-images="32.Linear.key-stage-0053anim0.svg,32.Linear.key-stage-0053anim1.svg,32.Linear.key-stage-0053anim2.svg" class="slide-image" />
       ...
       <section id="slide-053" class="anim">
            ...
            <img src="32.Linear.key-stage-0054anim0.svg" data-images="32.Linear.key-stage-0054anim0.svg,32.Linear.key-stage-0054anim1.svg" class="slide-image" />
       ...
       <section id="slide-056" class="anim">
            ...
            <img src="32.Linear.key-stage-0057anim0.svg" data-images="32.Linear.key-stage-0057anim0.svg,32.Linear.key-stage-0057anim1.svg,32.Linear.key-stage-0057anim2.svg" class="slide-image" />
       ...
       <section id="slide-057" class="anim">
            ...
            <img src="32.Linear.key-stage-0058anim0.svg" data-images="32.Linear.key-stage-0058anim0.svg,32.Linear.key-stage-0058anim1.svg,32.Linear.key-stage-0058anim2.svg,32.Linear.key-stage-0058anim3.svg" class="slide-image" />
       ...
       <section id="slide-063" class="anim">
            ...
            <img src="32.Linear.key-stage-0064anim0.svg" data-images="32.Linear.key-stage-0064anim0.svg,32.Linear.key-stage-0064anim1.svg,32.Linear.key-stage-0064anim2.svg" class="slide-image" />
       ...
       <section id="slide-067" class="anim">
            ...
            <img src="32.Linear.key-stage-0068anim0.svg" data-images="32.Linear.key-stage-0068anim0.svg,32.Linear.key-stage-0068anim1.svg" class="slide-image" />
       ...
       <section class="video" id="video-070">
           <a class="slide-link" href="https://mlvu.github.io/lecture06#video-70">link here</a>
           <iframe
       ...
       <section id="slide-074">
            ...
            <img src="32.Linear.key-stage-0074.png" class="slide-image" />
       ...
       <section id="slide-074" class="anim">
            ...
            <img src="32.Linear.key-stage-0075anim0.svg" data-images="32.Linear.key-stage-0075anim0.svg,32.Linear.key-stage-0075anim1.png,32.Linear.key-stage-0075anim2.png,32.Linear.key-stage-0075anim3.png,32.Linear.key-stage-0075anim4.png,32.Linear.key-stage-0075anim5.png,32.Linear.key-stage-0075anim6.png,32.Linear.key-stage-0075anim7.png" class="slide-image" />
       ...
       <section id="slide-077" class="anim">
            ...
            <img src="32.Linear.key-stage-0078anim0.svg" data-images="32.Linear.key-stage-0078anim0.svg,32.Linear.key-stage-0078anim1.svg,32.Linear.key-stage-0078anim2.svg" class="slide-image" />
       ...
       <section id="slide-079" class="anim">
            ...
            <img src="32.Linear.key-stage-0080anim0.svg" data-images="32.Linear.key-stage-0080anim0.svg,32.Linear.key-stage-0080anim1.svg,32.Linear.key-stage-0080anim2.svg,32.Linear.key-stage-0080anim3.svg" class="slide-image" />
       ...
       <section id="slide-080" class="anim">
            ...
            <img src="32.Linear.key-stage-0081anim0.svg" data-images="32.Linear.key-stage-0081anim0.svg,32.Linear.key-stage-0081anim1.svg,32.Linear.key-stage-0081anim2.svg" class="slide-image" />
       ...
       <section id="slide-083">
            ...
            <img src="32.Linear.key-stage-0083.png" class="slide-image" />
       ...
       <section id="slide-083" class="anim">
            ...
            <img src="32.Linear.key-stage-0084anim0.png" data-images="32.Linear.key-stage-0084anim0.png,32.Linear.key-stage-0084anim1.png" class="slide-image" />
       ...
       <section id="slide-084" class="anim">
            ...
            <img src="32.Linear.key-stage-0085anim0.png" data-images="32.Linear.key-stage-0085anim0.png,32.Linear.key-stage-0085anim1.png,32.Linear.key-stage-0085anim2.png" class="slide-image" />
       ...
       <section id="slide-085" class="anim">
            ...
            <img src="32.Linear.key-stage-0086anim0.svg" data-images="32.Linear.key-stage-0086anim0.svg,32.Linear.key-stage-0086anim1.svg,32.Linear.key-stage-0086anim2.svg" class="slide-image" />
       ...
       <section class="video" id="video-088">
           <a class="slide-link" href="https://mlvu.github.io/lecture06#video-88">link here</a>
           <iframe
       ...
       <section id="slide-093" class="anim">
            ...
            <img src="32.Linear.key-stage-0094anim0.svg" data-images="32.Linear.key-stage-0094anim0.svg,32.Linear.key-stage-0094anim1.svg" class="slide-image" />
       ...
       <section id="slide-094" class="anim">
            ...
            <img src="32.Linear.key-stage-0095anim0.svg" data-images="32.Linear.key-stage-0095anim0.svg,32.Linear.key-stage-0095anim1.svg,32.Linear.key-stage-0095anim2.svg,32.Linear.key-stage-0095anim3.svg,32.Linear.key-stage-0095anim4.svg" class="slide-image" />
       ...
       <section id="slide-095" class="anim">
            ...
            <img src="32.Linear.key-stage-0096anim0.svg" data-images="32.Linear.key-stage-0096anim0.svg,32.Linear.key-stage-0096anim1.svg,32.Linear.key-stage-0096anim2.svg" class="slide-image" />
       ...
       <section id="slide-098" class="anim">
            ...
            <img src="32.Linear.key-stage-0099anim0.svg" data-images="32.Linear.key-stage-0099anim0.svg,32.Linear.key-stage-0099anim1.svg,32.Linear.key-stage-0099anim2.svg" class="slide-image" />
       ...
       <section id="slide-099" class="anim">
            ...
            <img src="32.Linear.key-stage-0100anim0.svg" data-images="32.Linear.key-stage-0100anim0.svg,32.Linear.key-stage-0100anim1.svg" class="slide-image" />
       ...
       <section id="slide-101" class="anim">
            ...
            <img src="32.Linear.key-stage-0102anim0.svg" data-images="32.Linear.key-stage-0102anim0.svg,32.Linear.key-stage-0102anim1.svg,32.Linear.key-stage-0102anim2.svg,32.Linear.key-stage-0102anim3.svg,32.Linear.key-stage-0102anim4.svg" class="slide-image" />
       ...
       <section id="slide-102" class="anim">
            ...
            <img src="32.Linear.key-stage-0103anim0.svg" data-images="32.Linear.key-stage-0103anim0.svg,32.Linear.key-stage-0103anim1.svg" class="slide-image" />
       ...
       <section id="slide-105">
            ...
            <img src="32.Linear.key-stage-0105.svg" class="slide-image" />
       ...
       <section id="slide-106">
            ...
            <img src="32.Linear.key-stage-0106.png" class="slide-image" />
       ...
       <section id="slide-107" class="anim">
            ...
            <img src="32.Linear.key-stage-0108anim0.svg" data-images="32.Linear.key-stage-0108anim0.svg,32.Linear.key-stage-0108anim1.svg" class="slide-image" />
       ...
       <section id="slide-108" class="anim">
            ...
            <img src="32.Linear.key-stage-0109anim0.svg" data-images="32.Linear.key-stage-0109anim0.svg,32.Linear.key-stage-0109anim1.svg,32.Linear.key-stage-0109anim2.svg,32.Linear.key-stage-0109anim3.svg,32.Linear.key-stage-0109anim4.svg" class="slide-image" />
       ...
       <section id="slide-109" class="anim">
            ...
            <img src="32.Linear.key-stage-0110anim0.svg" data-images="32.Linear.key-stage-0110anim0.svg,32.Linear.key-stage-0110anim1.svg,32.Linear.key-stage-0110anim2.svg,32.Linear.key-stage-0110anim3.svg" class="slide-image" />
       ...
       <section id="slide-113">
            ...
            <img src="32.Linear.key-stage-0113.svg" class="slide-image" />
       ...
       <section id="slide-113" class="anim">
            ...
            <img src="32.Linear.key-stage-0114anim0.svg" data-images="32.Linear.key-stage-0114anim0.svg,32.Linear.key-stage-0114anim1.svg" class="slide-image" />
       ...
       <section id="slide-119">
            ...
            <img src="32.Linear.key-stage-0119.svg" class="slide-image" />
