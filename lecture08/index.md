...
<article class="slides">
       ...
       <section id="slide-092" class="anim">
            ...
            <figcaption>
            <p    ><br></p><p    >And there we have it: maximizing the log probability of the data as weighted by the responsibilites defined by <span class="red">q</span> gives us exactly the estimators we came up with intuitively in the previous step.</p><p    ></p>
            </figcaption>
            <span class="hint">click image for animation</span>
       </section>
