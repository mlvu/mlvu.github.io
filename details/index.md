...
<article class="slides">
        ...
        <section class="video" id="video-000">
           ...
           <video controls>
                <source src="https://pbm.thegood.cloud/s/J4qEaGBgZF2SmW5/download/Course%20details.mp4" type="video/mp4" />

                Download the <a href="https://pbm.thegood.cloud/s/J4qEaGBgZF2SmW5/download/Course%20details.mp4">video</a>.
           </video>
        </section>
       ...
       <section id="slide-001">
            ...
            <img src="CourseDetails.generic.key-stage-0001.svg" class="slide-image" />
       ...
       <section id="slide-002">
            ...
            <img src="CourseDetails.generic.key-stage-0002.svg" class="slide-image" />
       ...
       <section id="slide-003">
            ...
            <img src="CourseDetails.generic.key-stage-0003.svg" class="slide-image" />

            <figcaption>
            <p    >Here are the rules in detail. <br></p><p    >For <span>the exam and quizzes</span> you score <em>points</em>: 10 each for the quizzes and 40 for the exam, for a maximum total of 80 possible points. You need to score at least 52 points to pass, which corresponds to a grade of 5.5 for the examination. To support the exam and the quizzes, there are <em>homework exercises</em>. You should make these to prepare, but these are not graded. The answers are provided, so it’s up to you how you use them. There are weekly homework sessions to discuss the homework with your TA.<br></p><p    ><span>The project</span> is done in groups of 3. Here, the minimum grade is 4.5. The project is supported by group sessions, which start in the second week of the course.<br></p><aside    >Note that the minimum final grade is a 5.5, so if your project grade is below that you will need a higher examination grade (6.5 in the worst case) to pass.</aside><aside    ></aside>
            </figcaption>
       </section>
       ...
       <section id="slide-004">
            ...
            <img src="CourseDetails.generic.key-stage-0004.svg" class="slide-image" />
       ...
       <section id="slide-005">
            ...
            <img src="CourseDetails.generic.key-stage-0005.svg" class="slide-image" />
       ...
       <section id="slide-006" class="anim">
            ...
            <img src="CourseDetails.generic.key-stage-0006anim0.svg" data-images="CourseDetails.generic.key-stage-0006anim0.svg,CourseDetails.generic.key-stage-0006anim1.svg" class="slide-image" />
       ...
       <section id="slide-007" class="anim">
            ...
            <img src="CourseDetails.generic.key-stage-0007anim0.svg" data-images="CourseDetails.generic.key-stage-0007anim0.svg,CourseDetails.generic.key-stage-0007anim1.svg" class="slide-image" />

            <figcaption>
            <p    >On Canvas, in the syllabus, you will find <strong>practice exam A</strong>: this document gives example question, but it also explains in detail what the structure of the exam will be. Of particular note is the list of 10 <em>question types</em> for the application questions on the exam. We will select 4 or 5 question types from this list for the exam. The structure of these questions will always be exactly the same, with only small details changed. <br></p><p    >That means the application part of the exam will be extremely predictable: if you’ve practiced these 10 types of questions well, there will be no surprises in this part.<br></p><p    ></p>
            </figcaption>
            <span class="hint">click image for animation</span>
       </section>
       ...
       <section id="slide-008">
            ...
            <img src="CourseDetails.generic.key-stage-0008.svg" class="slide-image" />
       ...
       <section id="slide-009">
            ...
            <img src="CourseDetails.generic.key-stage-0009.svg" class="slide-image" />
       ...
       <section id="slide-010">
            ...
            <img src="CourseDetails.generic.key-stage-0010.svg" class="slide-image" />
       ...
       <section id="slide-013">
            ...
            <img src="CourseDetails.generic.key-stage-0014.svg" class="slide-image" />
       ...
       <section id="slide-014">
            ...
            <img src="CourseDetails.generic.key-stage-0015.svg" class="slide-image" />
       ...
       <section id="slide-015">
            ...
            <img src="CourseDetails.generic.key-stage-0016.png" class="slide-image" />
       ...
       <section id="slide-016">
            ...
            <img src="CourseDetails.generic.key-stage-0017.svg" class="slide-image" />
       ...
       <section id="slide-017">
            ...
            <img src="CourseDetails.generic.key-stage-0018.svg" class="slide-image" />
       ...
       <section id="slide-018">
            ...
            <img src="CourseDetails.generic.key-stage-0019.svg" class="slide-image" />
       ...
       <section id="slide-020">
            ...
            <img src="CourseDetails.generic.key-stage-0021.svg" class="slide-image" />
       ...
       <section id="slide-023">
            ...
            <img src="CourseDetails.generic.key-stage-0024.svg" class="slide-image" />
       ...
       <section id="slide-024">
            ...
            <img src="CourseDetails.generic.key-stage-0025.svg" class="slide-image" />
       ...
       <section id="slide-025">
            ...
            <img src="CourseDetails.generic.key-stage-0026.svg" class="slide-image" />
