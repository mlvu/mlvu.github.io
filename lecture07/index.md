...
<nav class="menu">
    <ul>
        ...
        <li class="name">Lecture 7: Deep learning</li>
                ...
                <li><a href="#video-018">Tensor backpropagation</a></li>
                <li><a href="#video-048">Convolutions</a></li>
                <li><a href="#video-065">Making it work</a></li>
...
<article class="slides">
       ...
       <section class="video" id="video-000">
           ...
           <iframe
                src="https://www.youtube.com/embed/ufvd0DC2_EI?modestbranding=1&showinfo=0&rel=0"
       ...
       <section id="slide-001">
            ...
            <figcaption>
            <p    >This is the first of several lectures that deal with deep learning. Deep learning evolved out of neural networks, but it’s slightly more than just the business of training very large and very deep neural nets. We’ll discuss exactly what makes a deep learning model at the end of the lecture. <br></p><p    ><lnbr></lnbr></p><p    ></p>
            </figcaption>
       </section>
       ...
       <section id="slide-013">
            ...
            <img src="32.DeepLearning1.key-stage-0013.svg" class="slide-image" />
       ...
       <section id="slide-016" class="anim">
            ...
            <img src="32.DeepLearning1.key-stage-0016anim0.svg" data-images="32.DeepLearning1.key-stage-0016anim0.svg,32.DeepLearning1.key-stage-0016anim1.svg,32.DeepLearning1.key-stage-0016anim10.svg,32.DeepLearning1.key-stage-0016anim2.svg,32.DeepLearning1.key-stage-0016anim3.svg,32.DeepLearning1.key-stage-0016anim4.svg,32.DeepLearning1.key-stage-0016anim5.svg,32.DeepLearning1.key-stage-0016anim6.svg,32.DeepLearning1.key-stage-0016anim7.svg,32.DeepLearning1.key-stage-0016anim8.svg,32.DeepLearning1.key-stage-0016anim9.svg" class="slide-image" />

            <figcaption>
            <p    >In eager mode deep learning systems, we create a node in our computation graph (called a Tensor here) by specifying what data it should contain. The result is a tensor object that stores <em>both </em>the data, and the gradient over that data (which will be filled later).<br></p><p    >Here we create the variables <span class="orange red">a</span> and <span class="green">b</span>. If we now apply a function to these, for instance to multiply their values, we can immediately compute the result: <span class="orange red">1</span> * <span class="green">2</span> = <span class="blue">2</span>. We take this result and put it in another Tensor object called <span class="blue">c</span>. We also store references to the variables that were used to create <span class="blue">c</span>, and the module that created it: we perform a computation, but we also keep a history of which computation we performed in the form of a graph.<br></p><p    >Using this graph, we can perform the backpropagation from a given starting node. Here, we compute the partial derivatives of <span class="blue">c</span> with respect to every node in the graph (including <span class="blue">c</span> itself).<br></p><aside    >These names and this syntax are loosely inspired by those of PyTorch, but the concepts are similar for all deep learning frameworks.</aside><aside    ></aside>
            </figcaption>
            <span class="hint">click image for animation</span>
       </section>
       ...
       <section id="slide-017" class="anim">
            ...
            <img src="32.DeepLearning1.key-stage-0017anim0.svg" data-images="32.DeepLearning1.key-stage-0017anim0.svg,32.DeepLearning1.key-stage-0017anim1.svg,32.DeepLearning1.key-stage-0017anim2.svg,32.DeepLearning1.key-stage-0017anim3.svg" class="slide-image" />

            <figcaption>
            <p    >With a computation graph like this,<em> if all the data are scalars</em>, it’s very easy to implement backpropagation. Say we’re interested in the derivative of <span class="blue">c</span> over <span class="orange red">a</span>. The chain rule tells us this is the derivative of <span class="green">b</span> over <span class="orange red">a</span> times that of <span class="blue">c</span> over <span class="green">b</span>. <span class="blue">c</span> over <span class="green">b</span> is the local derivative for function g, and <span class="green">b</span> over <span class="orange red">a</span> is the local derivative for function f. <br></p><p    >Starting at the output we can walk backward, and multiply all the local derivatives we encounter. At each step, we multiply the derivative of the output over the input.<br></p><p    >Next video, we’ll see what we need to do when the computation graph has a more complicated structure, and when the data nodes can contain tensors instead of scalars.</p><p    ></p>
            </figcaption>
            <span class="hint">click image for animation</span>
       </section>
       ...
       <section id="slide-018" class="anim">
            ...
            <figcaption>
            <p    >Here’s what a training loop would look like for a simple two-layer feedforward network. The computation graph shown below is rebuilt from scratch for every iteration of the training loop, and cleared at the end. The variables <span class="orange">W</span>, <span class="orange">V</span>, <span class="blue">b</span> and<span class="blue"> c</span>,  that define our neural network contain tensor data that is saved between iterations, and updated at every step of gradient descent.<br></p><p    >Note that the output of every module is also a Tensor, with its own data and its own gradient. Note that the multiplications are now matrix multiplications<br></p><p    >Once we have our computation graph in place, we have everything we need to start the backpropagation algorithm. To translate what we learned in the last video to this setting we’ll need some extra insights. We’ll go over those in the next video.</p><p    ></p>
            </figcaption>
            <span class="hint">click image for animation</span>
       </section>
       ...
       <section class="video" id="video-018">
           <a class="slide-link" href="https://mlvu.github.io/lecture07#video-18">link here</a>
           <iframe
                src="https://www.youtube.com/embed/S1_EBqA0pio?modestbranding=1&showinfo=0&rel=0"
                title="YouTube video player"
                frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                allowfullscreen>
           </iframe>
       ...
       <section id="slide-019">
            ...
            <img src="32.DeepLearning1.key-stage-0019.svg" class="slide-image" />
       ...
       <section id="slide-020" class="anim">
            ...
            <img src="32.DeepLearning1.key-stage-0020anim0.svg" data-images="32.DeepLearning1.key-stage-0020anim0.svg,32.DeepLearning1.key-stage-0020anim1.svg,32.DeepLearning1.key-stage-0020anim2.svg" class="slide-image" />

            <figcaption>
            <p    >In the previous video we explained how deep learning systems like Pytorch and Tensorflow allow us to build up a computation graph in code. Once we have this computation graph, we can use it to implement backpropagation.<br></p><p    ></p>
            </figcaption>
            <span class="hint">click image for animation</span>
       </section>
       ...
       <section id="slide-022" class="anim">
            ...
            <img src="32.DeepLearning1.key-stage-0022anim0.svg" data-images="32.DeepLearning1.key-stage-0022anim0.svg,32.DeepLearning1.key-stage-0022anim1.svg,32.DeepLearning1.key-stage-0022anim2.svg" class="slide-image" />
       ...
       <section id="slide-023">
            ...
            <img src="32.DeepLearning1.key-stage-0023.svg" class="slide-image" />
       ...
       <section id="slide-024" class="anim">
            ...
            <img src="32.DeepLearning1.key-stage-0024anim0.svg" data-images="32.DeepLearning1.key-stage-0024anim0.svg,32.DeepLearning1.key-stage-0024anim1.svg,32.DeepLearning1.key-stage-0024anim2.svg" class="slide-image" />
       ...
       <section id="slide-026">
            ...
            <img src="32.DeepLearning1.key-stage-0026.svg" class="slide-image" />
       ...
       <section id="slide-027" class="anim">
            ...
            <img src="32.DeepLearning1.key-stage-0027anim0.svg" data-images="32.DeepLearning1.key-stage-0027anim0.svg,32.DeepLearning1.key-stage-0027anim1.svg,32.DeepLearning1.key-stage-0027anim2.svg,32.DeepLearning1.key-stage-0027anim3.svg,32.DeepLearning1.key-stage-0027anim4.svg,32.DeepLearning1.key-stage-0027anim5.svg" class="slide-image" />
       ...
       <section id="slide-028">
            ...
            <img src="32.DeepLearning1.key-stage-0028.svg" class="slide-image" />
       ...
       <section id="slide-031" class="anim">
            ...
            <img src="32.DeepLearning1.key-stage-0031anim0.svg" data-images="32.DeepLearning1.key-stage-0031anim0.svg,32.DeepLearning1.key-stage-0031anim1.svg,32.DeepLearning1.key-stage-0031anim2.svg" class="slide-image" />
       ...
       <section id="slide-033" class="anim">
            ...
            <img src="32.DeepLearning1.key-stage-0036anim0.svg" data-images="32.DeepLearning1.key-stage-0036anim0.svg,32.DeepLearning1.key-stage-0036anim1.svg,32.DeepLearning1.key-stage-0036anim2.svg,32.DeepLearning1.key-stage-0036anim3.svg,32.DeepLearning1.key-stage-0036anim4.svg,32.DeepLearning1.key-stage-0036anim5.svg,32.DeepLearning1.key-stage-0036anim6.svg" class="slide-image" />
       ...
       <section id="slide-034" class="anim">
            ...
            <img src="32.DeepLearning1.key-stage-0037anim0.svg" data-images="32.DeepLearning1.key-stage-0037anim0.svg,32.DeepLearning1.key-stage-0037anim1.svg" class="slide-image" />
       ...
       <section id="slide-035" class="anim">
            ...
            <img src="32.DeepLearning1.key-stage-0038anim0.svg" data-images="32.DeepLearning1.key-stage-0038anim0.svg,32.DeepLearning1.key-stage-0038anim1.svg,32.DeepLearning1.key-stage-0038anim2.svg,32.DeepLearning1.key-stage-0038anim3.svg" class="slide-image" />
       ...
       <section id="slide-036" class="anim">
            ...
            <figcaption>
            <p    >To simplify this picture we will introduce some new notation. This is specific to this course (and the DLVU course), so don't expect to see it anywhere else, but it should hopefully simplify things a little bit.<br></p><p    >We know that we are always computing the gradient with respect to the loss, so we remove that from the notation. The thing we're most interested in is the tensor that we're computing the gradient <em>for</em>. In this case <strong class="orange red">A</strong>. We'll put that front and center (instead of in a asubscript) and put the nabla in the superscript (a bit like a transposition or inverse operator). The idea is that for any tensor <strong class="orange red">A</strong>, the notation <strong class="orange red">A</strong><sup>∇</sup> refers to a tensor of the same shape as <strong class="orange red">A</strong>, such that each element contains the partial derivative of the loss with respect to the corresponding element in <strong class="orange red">A</strong>.<br></p><p    ></p>
            </figcaption>
            <span class="hint">click image for animation</span>
       </section>
       ...
       <section class="video" id="video-048">
           <a class="slide-link" href="https://mlvu.github.io/lecture07#video-48">link here</a>
           <iframe
                src="https://www.youtube.com/embed/5PywqjN1hh0?modestbranding=1&showinfo=0&rel=0"
                title="YouTube video player"
                frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                allowfullscreen>
           </iframe>
       ...
       <section id="slide-057">
            ...
            <img src="32.DeepLearning1.key-stage-0061.svg" class="slide-image" />
       ...
       <section id="slide-063">
            ...
            <img src="32.DeepLearning1.key-stage-0067.png" class="slide-image" />
       ...
       <section id="slide-065">
            ...
            <img src="32.DeepLearning1.key-stage-0069.svg" class="slide-image" />
       ...
       <section class="video" id="video-065">
           <a class="slide-link" href="https://mlvu.github.io/lecture07#video-65">link here</a>
           <iframe
                src="https://www.youtube.com/embed/3UJjSRIKn10?modestbranding=1&showinfo=0&rel=0"
                title="YouTube video player"
                frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                allowfullscreen>
           </iframe>
       ...
       <section id="slide-066">
            ...
            <img src="32.DeepLearning1.key-stage-0072.svg" class="slide-image" />
       ...
       <section id="slide-069" class="anim">
            ...
            <img src="32.DeepLearning1.key-stage-0075anim0.svg" data-images="32.DeepLearning1.key-stage-0075anim0.svg,32.DeepLearning1.key-stage-0075anim1.svg" class="slide-image" />
       ...
       <section id="slide-070" class="anim">
            ...
            <img src="32.DeepLearning1.key-stage-0076anim0.svg" data-images="32.DeepLearning1.key-stage-0076anim0.svg,32.DeepLearning1.key-stage-0076anim1.svg,32.DeepLearning1.key-stage-0076anim2.svg" class="slide-image" />
       ...
       <section id="slide-071">
            ...
            <img src="32.DeepLearning1.key-stage-0077.svg" class="slide-image" />
       ...
       <section id="slide-077" class="anim">
            ...
            <img src="32.DeepLearning1.key-stage-0083anim0.svg" data-images="32.DeepLearning1.key-stage-0083anim0.svg,32.DeepLearning1.key-stage-0083anim1.svg" class="slide-image" />
       ...
       <section id="slide-078">
            ...
            <img src="32.DeepLearning1.key-stage-0084.svg" class="slide-image" />
       ...
       <section id="slide-083">
            ...
            <img src="32.DeepLearning1.key-stage-0089.svg" class="slide-image" />
       ...
       <section id="slide-086">
            ...
            <img src="32.DeepLearning1.key-stage-0093.svg" class="slide-image" />
       ...
       <section id="slide-093">
            ...
            <figcaption>
            <p    >Sometimes a regularization term is something that you tack onto your model in an ad-hoc fashion: you see that it is overfitting, so you add a little regularization.<br></p><p    >Other times, it appears naturally. We saw this in the last lecture, where we rewrote the SVM soft margin loss to an error term and a regularization term.<br></p><aside    >Here the penalty hyperparameter <span class="orange red">C</span> is on the error term, and not on the regularization term, but practically it doesn’t make much of a difference which term you control.</aside><aside    ></aside>
            </figcaption>
       </section>
       ...
       <section id="slide-094">
            ...
            <img src="32.DeepLearning1.key-stage-0102.svg" class="slide-image" />
       ...
       <section id="slide-096">
            ...
            <img src="32.DeepLearning1.key-stage-0105.svg" class="slide-image" />
       ...
       <section id="slide-098">
            ...
            <img src="32.DeepLearning1.key-stage-0107.png" class="slide-image" />
       ...
       <section id="slide-099">
            ...
            <img src="32.DeepLearning1.key-stage-0108.svg" class="slide-image" />
       ...
       <section id="slide-100">
            ...
            <img src="32.DeepLearning1.key-stage-0109.png" class="slide-image" />
       ...
       <section id="slide-102" class="anim">
            ...
            <img src="32.DeepLearning1.key-stage-0111anim0.svg" data-images="32.DeepLearning1.key-stage-0111anim0.svg,32.DeepLearning1.key-stage-0111anim1.svg" class="slide-image" />
       ...
       <section id="slide-103">
            ...
            <img src="32.DeepLearning1.key-stage-0112.svg" class="slide-image" />
       ...
       <section id="slide-105">
            ...
            <img src="32.DeepLearning1.key-stage-0114.svg" class="slide-image" />
       ...
       <section id="slide-106" class="anim">
            ...
            <img src="32.DeepLearning1.key-stage-0115anim0.svg" data-images="32.DeepLearning1.key-stage-0115anim0.svg,32.DeepLearning1.key-stage-0115anim1.svg" class="slide-image" />
